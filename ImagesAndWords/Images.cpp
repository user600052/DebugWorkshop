...
Image *ReadImage(const char* filename)
{
	...
	// calculate image size
	unsigned int imgsize = img->header.width * img->header.height;
...
int main()
{
	// the problem was the total size of img2 was over uint16's size
	// so i increased the check to unsigned int instead and it was enough to contain the
	// tampered image
